...
- `rocm_join_if_set` joins strings with a specified glue, and appends to a specified variable if it exists, setting that variable to the result if it doesn't exist'
### Changed
